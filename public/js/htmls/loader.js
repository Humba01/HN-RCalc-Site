...
const textContents = {
  cards: {
    titulos: {
      ...
      formulasDeTransformacaoTechno: 'Fórmulas de Transformação',
    ...
    textos: {
      ...
      conversoresDeBases: [
        ...
        'Bases Math de Ângulo Covencional',
        ...
        'Bases Physic de Espaço',
        'Bases Physic de Aceleração',
        'Bases Physic de Corrente Elétrica',
        'Bases Physic de Pressão e Tensão',
        'Bases Physic de Energia, Trabalho e Quantidade de Calor',
        'Bases Physic de Potência e Fluxo de Energia',
        'Bases Physic de Carga Elétrica e Quantidade de Eletricidade',
        'Bases Physic da Diferença de Potencial Elétrico',
        'Bases Physic da Capacitância',
        'Bases Physic da Condutância Elétrica',
        'Bases Physic da Resistência Elétrica',
        'Bases Physic da Fluxo de Indução Magnética',
        'Bases Physic da Indução Magnética',
        'Bases Physic da Indutância',
        'Bases Physic da Intensidade Luminosa',
        'Bases Physic da Iluminância',
        'Bases Chemical de Atividade Radionuclear',
        'Bases Chemical de Dose Absorvida, Energia Específica e Kernea',
        'Bases Chemical de Dose Equivalente e Dose Equivalente Ambiental',
        'Bases Chemical da Atividade Catalítica',
        'Bases Chemical da Quantidade de Substância',
      ],
      formulasMatematicas: [
        ...
        'Secção de um Cilindro',
        'Área Lateral de uma Esfera',
        'Volume de uma Esfera',
        'Equação Apolar Trigonométrica'
      ],
      formulasFisicas: [
